...
class PhasePiledFractureHSMarkerNoAD : public QuadraturePointMarker, public Coupleable
{
public:
  static InputParameters validParams();

  PhasePiledFractureHSMarkerNoAD(const InputParameters & parameters);
...
protected:
  ...
  // 材料变量
  const MaterialProperty<Real> & _sigma0;
