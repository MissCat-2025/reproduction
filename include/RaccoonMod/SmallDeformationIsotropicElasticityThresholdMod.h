// SmallDeformationIsotropicElasticityThresholdMod.h
#pragma once
 ...
 */
class SmallDeformationIsotropicElasticityThresholdMod : public SmallDeformationElasticityModelMod,
                                                    public DerivativeMaterialPropertyNameInterface
{
public:
  static InputParameters validParams();
  SmallDeformationIsotropicElasticityThresholdMod(const InputParameters & parameters);
