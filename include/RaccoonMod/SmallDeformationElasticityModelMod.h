...
class SmallDeformationElasticityModelMod : public Material, public BaseNameInterface
{
public:
  static InputParameters validParams();

  SmallDeformationElasticityModelMod(const InputParameters & parameters);

  /// Set the current quadrature point
  virtual void setQp(unsigned int qp);

  /// Set the associated plasticity model
  virtual void setPlasticityModel(SmallDeformationPlasticityModelMod * plasticity_model);
