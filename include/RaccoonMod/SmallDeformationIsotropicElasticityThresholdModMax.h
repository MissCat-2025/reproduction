// SmallDeformationIsotropicElasticityThresholdModMax.h
#pragma once
 ...
 */
class SmallDeformationIsotropicElasticityThresholdModMax : public SmallDeformationElasticityModelMod,
                                                    public DerivativeMaterialPropertyNameInterface
{
public:
  static InputParameters validParams();
  SmallDeformationIsotropicElasticityThresholdModMax(const InputParameters & parameters);
