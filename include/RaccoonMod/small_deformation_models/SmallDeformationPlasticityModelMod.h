...
class SmallDeformationPlasticityModelMod : public Material,
...
public:
  ...
  SmallDeformationPlasticityModelMod(const InputParameters & parameters);
  ...
  virtual void setElasticityModel(SmallDeformationElasticityModelMod * elasticity_model);
