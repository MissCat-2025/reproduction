...
# conda activate moose && dos2unix in573_15.i &&mpirun -n 2 /home/yp/projects/reproduction/reproduction-opt -i in573_15.i
initial_T = 558.2
initial_T_out = 560.8
EndTime = 110000000
pellet_nu = 0.345
...
[Functions]
  ...
  [gc_function]
    type = PiecewiseLinear
    x = '200 400 600 800 1000 1200 1400 1600 1800 2000 2200 2400'
    y = '0.111586 0.183115 0.244658 0.300497 0.352446 0.401490 0.448245 0.493124 0.536426 0.578373 0.619138 0.658857'#假设x倍He
  scale_factor = 1
  []
[]
...
[Outputs]
  ...
  file_base = 'gap_conductance1/0.25'
  # csv = true
  [./csv]
    type = CSV
