...
# conda activate moose && dos2unix in603_15.i &&mpirun -n 2 /home/yp/projects/reproduction/reproduction-opt -i in603_15.i
initial_T = 589.5
initial_T_out = 611.8
EndTime = 110000000
pellet_nu = 0.345
...
[Functions]
  ...
  [gap_conductance_function_in]
    ...
    x_index_in_file = 10  # 0.5innerBu 列（第3列，索引从0开始）
    y_index_in_file = 11  # 0.5innerConductance 列（第4列，索引从0开始）
  ...
  [gap_conductance_function_out]
    ...
    data_file = '../../.././AllConductance.csv'
    format = columns  # CSV 数据格式为列式
    x_index_in_file = 4  # 0.5outerBu 列（第3列，索引从0开始）
    y_index_in_file = 5  # 0.5outerConductance 列（第4列，索引从0开始）
    xy_in_file_only = false
    scale_factor = 1
  []
[]
