...
# conda activate moose && dos2unix 2D_Main.i&& dos2unix 2D_Sub.i &&mpirun -n 10 /home/yp/projects/reproduction/reproduction-opt -i 2D_Main.i
initial_T = 293.15
initial_T_in = 570.7
initial_T_out = 582.8
LinearPower = 90
...
[Kernels]
  #力平衡方程
    ...
    [gps_offdiag_disp_x]
      ...
      eigenstrain_names = 'thermal_eigenstrain_reg'
      base_name = gps
    []
    [gps_offdiag_disp_y]
      type = GeneralizedPlaneStrainOffDiag
...
[Materials]
  ...
  []
    ...
    [convert_stress]
      ...
      block = pellet
    []
        [convert_jacobian_mult]
      type = RankFourTensorMaterialADConverter
      ad_props_in = 'elasticity_tensor'
