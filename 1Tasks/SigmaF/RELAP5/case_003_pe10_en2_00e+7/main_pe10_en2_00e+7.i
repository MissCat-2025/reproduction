...
[MultiApps]
  [fracture]
    ...
    input_files = 'sub_pe10_en2_00e+7.i'
...
[Materials]
    ...
    [sigma0]
      ...
      material_property_names = 'burnup'
      expression = 'sigma0_F_Density*1.7*10^8*(1-2.62*(1-density/10960))^0.5*exp(-1590/8.314/T)*(1-(burnup/(0.1+burnup)))'
