# === 参数研究案例 ===
# dt1: 1
# 生成时间: 2026-01-16 20:12:52



#conda activate moose && mpirun -n 11 /home/yp/projects/reproduction/reproduction-opt -i main_dt1.i --recover
...
#第二个节点：观察结束时的节点
WatchTime = 60   #s 功率上升后的观察时间(一般以裂纹稳定后为准)
endTime = '${fparse PowerTimeTotal+WatchTime+100}'  #s 观察结束时的时间
...
ksi = 2
[Mesh]
  file = '/home/yp/projects/reproduction/1Tasks/step2/3_2026/s2PowerOn/s1Dt/case_001_dt1/2.1-2D-New2026/1_cp/0165-mesh.cpa.gz'
  distribution = serial
[]

[Problem]
  restart_file_base = '/home/yp/projects/reproduction/1Tasks/step2/3_2026/s2PowerOn/s1Dt/case_001_dt1/2.1-2D-New2026/1_cp/0165'
[]
