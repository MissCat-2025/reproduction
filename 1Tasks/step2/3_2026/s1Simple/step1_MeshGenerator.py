...
template_main = os.path.join(base_dir, '2.1main.i')
template_sub = os.path.join(base_dir, '2.1_Sub.i')
...
parameter_matrix = {
    ...
    'pellet_critical_energy':[5,6,7,8,9,10],
    # 'min_gap':[8e-6],       # 'gap2': [0.58,0.55,0.50],
    'length_scale_paramete': [5e-5,4e-5],
    'dt': [2500,2000,1500],
    # 'pellet_nu':[0.345],
    # 'Gc': [4,5,6,7,8,10],
