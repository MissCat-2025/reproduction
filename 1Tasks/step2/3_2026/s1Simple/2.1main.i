...
endTime__50000 = '${fparse endTime__100000+50000}'
...
[MultiApps]
  [fracture]
    ...
    cli_args = 'l=${length_scale_paramete};mesh_size=${mesh_size};Gc=${pellet_critical_energy};sigma0=${pellet_critical_fracture_strength};m=${m};w=${w};a2=${a2};a3=${a3};ksi=${ksi};endTime=${endTime};dtmin=${dtmin};dt=${dt};dt2=${dt2};pellet_outer_radius=${pellet_outer_radius};dtMax=${dtMax}'
...
[Functions]
  ...
  [power_history] #新加的！！！！！！！！！！！！！！！！！！！！！！
  type = PiecewiseLinear
    x = '0.0 2400.0 98400.0 ${endTime__100000} ${endTime__50000} ${endTime}'00
  ...
  [dt_limit_func]
    ...
    expression = 'if(t < 1000, 500,
                  ...
                  if(t < (${endTime__50000}-10000),${dt},
                  if(t < (${endTime__50000}+10000),${dt2},10000))))))'
  []
  [T_infinity_out]
      #间隙压力随时间的变化
    type = PiecewiseLinear
