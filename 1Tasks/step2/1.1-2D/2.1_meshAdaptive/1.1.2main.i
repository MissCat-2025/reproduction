# === 参数研究案例 ===
# conda activate moose && dos2unix 1.1.2main.i && dos2unix 1.1.2sub.i && mpirun -n 14 /home/yp/projects/reproduction/reproduction-opt -i 1.1.2main.i
...
pellet_critical_energy=${fparse (1+grid_sizes/2/4/length_scale_paramete)*Gc} #J⋅m-2。4是因为网格尺寸细化原来的4倍
