...
# 基础配置
base_dir = '/home/yp/projects/reproduction/Tasks/step2/1.1-2D/1.1.2Fracture'
# 主程序模板文件与子程序模板文件相同，则是单程序模式
template_main = os.path.join(base_dir, '1.1.2main.i')
template_sub = os.path.join(base_dir, '1.1.2sub.i')
...
# 参数矩阵定义 (在此修改需要研究的参数)
parameter_matrix = {
    'length_scale_paramete': [6e-5,5e-5,4e-5],
    'NNN': [1.2,1.5,2,2.5,3],
}
