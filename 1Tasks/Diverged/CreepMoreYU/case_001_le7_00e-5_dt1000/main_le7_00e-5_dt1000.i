# === 参数研究案例 ===
# end_time = 1.00e+5
# length_scale_paramete: 7.00e-5
# dt: 1000
# 生成时间: 2025-12-24 23:25:06
...
[MultiApps]
  [fracture]
    ...
    input_files = 'sub_le7_00e-5_dt1000.i'
    cli_args = 'l=${length_scale_paramete};mesh_size=${mesh_size};m=${m};w=${w};a2=${a2};a3=${a3};endTime=${endTime};dtmin=${dtmin};dt=${dt};pellet_inner_diameter=${pellet_inner_diameter};pellet_outer_diameter=${pellet_outer_diameter}'
...
[Materials]
    ...
    [largestPoreSize]
      ...
      expression = 'PS+PS*1*(burnup/(0.05+burnup))'
      constant_names = 'PS'
    ...
    [porosity]
      ...
      material_property_names = 'burnup'
      expression = 'p0+p0*1.44*(burnup/(0.05+burnup))'
      constant_names = 'p0'
    ...
    [creep]
      ...
      absolute_tolerance = 1e-12 #蠕变的绝对残差
...
[dt_limit_func]
  ...
  expression = 'if(t < 12000, 2000,
                 if(t < 110000, ${dt},
                 if(t < (${endTime__100000}-5000),100000,
...
#=================================================
  ...
  dtmin = ${dtmin}
  dtmax = 50000
  end_time = 100000#${endTime} # 总时间24h
