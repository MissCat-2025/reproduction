...
[Materials]
    ...
    [largestPoreSize]
      ...
      expression = 'PS+PS*3*(burnup/(0.015+burnup))'
      constant_names = 'PS'
    ...
    [porosity]
      ...
      material_property_names = 'burnup'
      expression = 'p0+p0*4.5*(burnup/(0.01+burnup))'
      constant_names = 'p0'
    ...
    [sigma0_F_factor]
      ...
      expression = 'if(sigma0_F_Density < 1.05, max(0.0, 1 - (1 - sigma0_F_Density) * (1 + burnup / (0.01 + burnup))), sigma0_F_Density)'
