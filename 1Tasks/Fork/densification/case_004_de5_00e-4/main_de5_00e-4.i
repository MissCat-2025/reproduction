# === 参数研究案例（对齐配对） ===
# end_time = 1.00e+5
# densificationMax: 5.00e-4
# 生成时间: 2025-12-17 23:05:29
...
largestPoreSize = 48
porosity0 = 3.6
densificationMax = 5.00e-4#《《下面数据取自[1]Thermomechanical Analysis and Irradiation Test of Sintered Dual-Cooled Annular pellet》》
...
[MultiApps]
  [fracture]
    ...
    input_files = 'sub_de5_00e-4.i'
    cli_args = 'l=${length_scale_paramete};mesh_size=${mesh_size};m=${m};w=${w};a2=${a2};a3=${a3};endTime=${endTime}'
