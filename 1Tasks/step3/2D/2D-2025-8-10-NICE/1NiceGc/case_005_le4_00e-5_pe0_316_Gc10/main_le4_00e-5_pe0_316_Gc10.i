...
[MultiApps]
  [fracture]
    ...
    input_files = 'sub_le4_00e-5_pe0_316_Gc10.i'
...
[Materials]
    ...
    [sigma0]
      ...
      expression = 'sigma00*(1-0.75*burnup/0.01)'
    ...
    [pellet_Gc]
      ...
      expression = 'Gc1*(1-0.95*burnup/0.015)'
      constant_names = 'Gc1'
...
[Adaptivity]
  ...
  [Markers]
    [marker]
      ...
      y1 = 1.5e7 #vonMises应力小于y1时，标记为粗网格
      y2 = 1.5e7 #vonMises应力大于y2之间时，标记为细网格
      variable = d
