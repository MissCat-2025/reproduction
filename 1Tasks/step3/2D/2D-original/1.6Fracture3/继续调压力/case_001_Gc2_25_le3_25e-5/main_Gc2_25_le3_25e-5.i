...
[MultiApps]
  [fracture]
    ...
    input_files = 'sub_Gc2_25_le3_25e-5.i'
...
[Transfers]
  ...
  [to_ALL]
    ...
    variable = 'psie_active a1 vonMises psic_active'
    source_variable = 'psie_active a1 vonMises psic_active'
  []
[]
...
[Functions]
  ...
  type = PiecewiseLinear #论文的功率历史
    x = '0          800000   6912000   7512001   8208000'
    y = '0          105     105     0     0'
...
[]
  [dt_limit_func]
    type = ParsedFunction
    expression = 'if(t < 900000, 2000,
                   if(t < 6912000, 20000,
                   if(t < 7512001, 2000,
                   if(t < 8208000, 10000,50000))))'
  []
[]
...
[Adaptivity]
  ...
  [Markers]
    [marker]
      ...
      y1 = 3.2e7 #vonMises应力小于y1时，标记为粗网格
