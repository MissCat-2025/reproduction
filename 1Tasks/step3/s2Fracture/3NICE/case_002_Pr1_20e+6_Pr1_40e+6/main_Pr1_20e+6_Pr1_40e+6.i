...
# conda activate moose && dos2unix main_Pr1_20e+6_Pr1_40e+6.i&& dos2unix sub_Pr1_20e+6_Pr1_40e+6.i &&mpirun -n 12 /home/yp/projects/reproduction/reproduction-opt -i main_Pr1_20e+6_Pr1_40e+6.i
initial_T = 293.15
initial_T_in = 570.7
initial_T_out = 582.8
LinearPower = 90
...
[MultiApps]
  [fracture]
    ...
    input_files = 'sub_Pr1_20e+6_Pr1_40e+6.i'
...
[dt_limit_func]
  ...
  expression = 'if(t < 12000, 2000,
                 if(t < 110000, 500,
                 if(t < (${endTime__100000}-500),50000,
