...
# conda activate moose && mpirun -n 12 /home/yp/projects/reproduction/reproduction-opt -i main_fi1_80e+19_la58_pe3.i
initial_T = 293.15
initial_T_in = 570.7
initial_T_out = 582.8
LinearPower = 90
...
[MultiApps]
  [fracture]
    ...
    input_files = 'sub_fi1_80e+19_la58_pe3.i'
...
[Materials]
    ...
    [pellet_properties2]
      ...
      prop_names = 'l nu density Gc largestPoreSize'
      prop_values = '${length_scale_paramete} ${pellet_nu} ${pellet_density} ${pellet_critical_energy} ${largestPoreSize}'
...
[]
  [dt_limit_func]
    ...
    expression = 'if(t < 12000, 2000,
                  if(t < 110000, 500,
                  if(t < (${endTime__100000}-1000),50000,
