...
[Functions]
  ...
  # [gc_function]
  #   type = PiecewiseLinear
  #   x = '273.15 800 1500 2500'
  #   y = '0.1405 0.350 0.5 0.600'#假设x倍He
  # scale_factor = 1
  # []
  [gap_conductance_function_out]
    type = PiecewiseLinear
    x = '0 0.000966054 0.002298609 0.004975111 0.006827309 0.007786267 0.008744437 0.010170977 0.024741463'
    y = '20348 7436 13253 17545 20560 22805 25857 31663 31045'#假设x倍He
  scale_factor = 1
  []
[]
...
[Outputs]
  ...
  file_base = 'gap_conductance5000/2D'
  # csv = true
  [./csv]
    type = CSV
    execute_on = 'TIMESTEP_END'
    show = 'burnup h_eq_inner h_eq_outer h_gap_eq_inner h_gap_eq_outer pellet_inner_T_avg pellet_T_max pellet_outer_T_avg'
  [../]
[]
