...
[MultiApps]
  [fracture]
    ...
    input_files = 'sub_le3_50e-5_Gc7_5_me1_20e-4.i'
...
[Materials]
    ...
    [sigma0]
      ...
      expression = 'sigma00*(1-0.7*burnup/0.01)'
    ...
    [pellet_Gc]
      ...
      expression = 'Gc1*(1-0.5*burnup/0.021)'
      constant_names = 'Gc1'
...
[Executioner]
  ...
  accept_on_max_fixed_point_iteration = false # 达到最大迭代次数时接受解
  dtmin = 100
  dtmax = 50000
  end_time = 110000 # 总时间24h
...
[Adaptivity]
  ...
  [Markers]
    [marker]
      ...
      y1 = 2.5e7 #vonMises应力小于y1时，标记为粗网格
      y2 = 2.5e7 #vonMises应力大于y2之间时，标记为细网格
      variable = d
