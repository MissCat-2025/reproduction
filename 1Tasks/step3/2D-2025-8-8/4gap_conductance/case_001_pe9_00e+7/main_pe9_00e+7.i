# === 参数研究案例 ===
# end_time = 1.00e+7
# pellet_critical_fracture_strength: 9.00e+7
# 生成时间: 2025-08-08 22:22:37
...
Gc = 2.896 #断裂能
# dt = 50000
pellet_critical_fracture_strength = 9.00e+7#Pa
fission_rate=50.0e19
grain_size = 10
...
[Transfers]
  ...
  [to_ALL]
    ...
    variable = 'psie_active a1 vonMises Gc'
    source_variable = 'psie_active a1 vonMises Gc'
  []
[]
...
[Materials]
    ...
    [sigma0]
      ...
      expression = 'sigma00*(1-0.5*burnup/0.0354)'
    ...
    [pellet_Gc]
      ...
      expression = 'Gc1*(1-0.5*burnup/0.011)'
      constant_names = 'Gc1'
...
[T_infinity]
  #间隙压力随时间的变化
  type = PiecewiseLinear
  x = '0   8208000 8210000 10000000'
  y = '313.15 313.15 293.15 293.15'
  scale_factor = 1
[]
  [dt_limit_func]
    type = ParsedFunction
    expression = 'if(t < 11773, 25,
                   if(t < 3242671, 10000,
                   if(t < 8103501, 10000,
