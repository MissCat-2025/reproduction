...
[Materials]
    ...
    [pellet_thermal_conductivity] #新加的！！！！！！！！！！！！！！！！！！！！！！
      ...
      expression = '(1-0.1*d)*(100/(7.5408 + 17.692*T/1000 + 3.6142*(T/1000)^2) + 6400/((T/1000)^2.5)*exp(-16.35/(T/1000)))'
      block = pellet
    []
    ...
    [pellet_Gc]
      ...
      expression = 'Gc1*(1-burnup/0.0354)'
      constant_names = 'Gc1'
    ...
    [pellet_strain]
      ...
      output_properties = 'thermal_eigenstrain swelling_eigenstrain'
      outputs = exodus
      block = pellet
    []
    [crack_geometric]
