...
# 生成时间: 2026-01-02 14:17:26

# conda activate moose && mpirun -n 12 /home/yp/projects/reproduction/reproduction-opt -i main_fi4_00e+19.i --recover
initial_T = 293.15
initial_T_in = 570.7
initial_T_out = 582.8
LinearPower = 90
...
mesh_size = '${fparse 0.5^w*length_scale_paramete}' #网格尺寸即可
...
[Materials]
    ...
    [largestPoreSize]
      ...
      expression = 'PS+PS*1*(burnup/(0.02+burnup))'
      constant_names = 'PS'
    ...
    [porosity]
      ...
      material_property_names = 'burnup'
      expression = 'p0+p0*1.44*(burnup/(0.02+burnup))'
      constant_names = 'p0'
