...
#include "UO2CreepRateBaseJ2Creep.h"

registerMooseObject("reproductionApp", UO2CreepRateBaseJ2Creep);

InputParameters
UO2CreepRateBaseJ2Creep::validParams()
{
  InputParameters params = J2Creep::validParams();
...
UO2CreepRateBaseJ2Creep::UO2CreepRateBaseJ2Creep(const InputParameters & parameters)
  : J2Creep(parameters),
...
void
UO2CreepRateBaseJ2Creep::setQp(unsigned int qp)
{
  J2Creep::setQp(qp);
...
ADReal
UO2CreepRateBaseJ2Creep::computeCreepRate(const ADReal & effective_stress, const ADReal & effective_creep_strain)
{
  // 计算稳态蠕变率
...
ADReal
UO2CreepRateBaseJ2Creep::computeTransientTimeFactor()
{
  // 获取自最大应力施加以来的时间
...
void
UO2CreepRateBaseJ2Creep::updateMaxStressHistory(const ADReal & effective_stress)
{
  // 获取当前应力的数值
...
ADReal
UO2CreepRateBaseJ2Creep::computeCreepRateStrainDerivative(const ADReal & effective_stress, const ADReal & effective_creep_strain)
{
