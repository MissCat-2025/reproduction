#include "SmallDeformationH.h"
#include "RankTwoScalarTools.h"
#include "RaccoonUtils.h"

registerMooseObject("reproductionApp", SmallDeformationH);

InputParameters
SmallDeformationH::validParams()
{
...
SmallDeformationH::SmallDeformationH(const InputParameters & parameters)
...
ADRankTwoTensor
SmallDeformationH::computeStress(const ADRankTwoTensor & strain)
{
