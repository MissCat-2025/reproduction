...
#第二个节点：功率突升的结束时的节点
PowerTime = 1920  #s 功率从x%增加到100%的时间
...
[MultiApps]
  [fracture]
    ...
    input_files = 'sub_Po1920.i'
    cli_args = 'l=${length_scale_paramete};mesh_size=${mesh_size};Gc=${pellet_critical_energy};sigma0=${pellet_critical_fracture_strength};m=${m};w=${w};a2=${a2};a3=${a3};ksi=${ksi};pellet_outer_radius=${pellet_outer_radius};xTime=${xTime};endTime=${endTime};dtmin=${dtmin};dt1=${dt1};timePlus1=${timePlus1}'
    execute_on = 'TIMESTEP_END'
        # 强制同步参数
        sub_cycling = false          # 禁止子循环
        catch_up = true              # 子程序失败后尝试用更小dt追赶，失败则触发主程序cutback
        max_catch_up_steps = 10      # 允许追赶的最大步数
  []
[]
