...
#conda activate moose &&mpirun -n 16 /home/yp/projects/reproduction/reproduction-opt -i Main.i

pellet_E=201.3e9
pellet_density=10431.0#10431.0*0.85#kg⋅m-3
pellet_nu = 0.316
pellet_thermal_expansion_coef=1e-5#K-1
pellet_critical_energy = 4 #断裂能
grain_size = 10.0
...
[MultiApps]
  [fracture]
    ...
    input_files = 'sub_pe4_pe0_316.i'
    cli_args = 'Gc=${pellet_critical_energy};l=${length_scale_paramete};pellet_outer_radius=${pellet_outer_radius};mesh_size=${mesh_size};m=${m};a2=${a2};a3=${a3};ksi=${ksi};degradation_factor=${degradation_factor}'
