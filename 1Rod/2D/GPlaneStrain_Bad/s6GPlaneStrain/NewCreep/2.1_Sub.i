...
[pff_diffusivity_ad]
  ...
  property_name = pff_diffusivity_ad
  expression = '2*Gc*l'
...
[pff_diffusivity]
  ...
  ad_props_in = pff_diffusivity_ad
  reg_props_out = pff_diffusivity
  block = pellet
[]
[a11]
  type = ADParsedMaterial
...
[]
  ...
  [psi]
    ...
    property_name = psi
    expression = 'alpha*Gc/l+g*(psie_active)'
    coupled_variables = 'd psie_active'
    material_property_names = 'alpha(d) g(d) Gc l'
    derivative_order = 2
