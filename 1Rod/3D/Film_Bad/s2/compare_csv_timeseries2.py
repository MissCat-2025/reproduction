...
# python /home/yp/projects/fuel_rods/SomeTests/Rods/compare_csv_timeseries2.py --input-dir /home/yp/projects/fuel_rods/SomeTests/Rods/parameter_studies
CSV_PATHS = [
...
def main(argv=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Input directory to recursively search for *_csv.csv files",
    )
    ...
    if args.input_dir:
        ...
        # Find all *_csv.csv files recursively
        csv_list = sorted(list(input_dir.rglob("*_csv.csv")))
        print(f"Found {len(csv_list)} CSV files in {input_dir}")
    else:
