...
pellet_critical_energy = 3 #断裂能
grain_size = 10.0
pellet_critical_fracture_strength=6.0e7#Pa
length_scale_paramete = 4.5e-5
mesh_size = 4.0e-5 #mm,最大网格尺寸
...
[MultiApps]
  [fracture]
    ...
    input_files = 'sub_pe1_00e+10.i'
    cli_args = 'Gc=${pellet_critical_energy};l=${length_scale_paramete};pellet_outer_radius=${pellet_outer_radius};mesh_size=${mesh_size};length=${length};m=${m};a2=${a2};a3=${a3};ksi=${ksi}'
