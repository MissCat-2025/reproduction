...
# conda activate moose && dos2unix MainA7.i&& dos2unix SubA7.i && mpirun -n 9 /home/yp/projects/reproduction/reproduction-opt -i MainA7.i --mesh-only
...
length_scale_paramete = 1.6e-5         #3.14*1.6e-5=5e-5，10e-5为随机场特征尺寸,5e-5为随机场网格尺寸，1.6e-5为裂纹宽度，0.8为最大网格尺寸
...
pellet_area0_full = '${fparse 3.141592653589793*(pellet_outer_radius*pellet_outer_radius - pellet_inner_radius*pellet_inner_radius)}'
...
[BCs]
  ...
  coefficient =3500 # W·m-2 K-1！gap_conductance_out！！！！！！！！！！！！！！！！！！！！！！！！！！
  []
...
[Materials]
    ...
    [sigma0]
      ...
      material_property_names = 'porosity largestPoreSize'
      ...
      constant_names = 'GS density'
      constant_expressions = '${grain_size} ${pellet_density}'
      output_properties = 'sigma0'
      outputs = exodus
      block = pellet
    []
...
[Functions]
  ...
  # [gap_conductance_in]
  #   type = PiecewiseLinear
  #   data_file = '/home/yp/projects/reproduction/2Annular/GapConductance/2D.csv'
  #   x_index_in_file = 0
  #   y_index_in_file = 4
...
[Postprocessors]
  ...
  [pellet_area_ratio_full]
    ...
    pp_names = 'pellet_area'
    expression = '4*pellet_area/pellet_area0_full'
    constant_names = 'pellet_area0_full'
    constant_expressions = '${pellet_area0_full}'
  []
[]
[Outputs]
  ...
  hide = 'pellet_area'
  file_base = 'Output/C_${WeibullShape}'
[]
