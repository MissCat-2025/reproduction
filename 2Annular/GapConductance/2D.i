...
# conda activate moose && dos2unix 2D.i &&mpirun -n 15 /home/yp/projects/reproduction/reproduction-opt -i 2D.i
initial_T = 570.7
initial_T_out = 582.8
linePower = 90
EndTime = 1e8
...
[UserObjects]
  ...
  [closedIn]
    ...
    primary_hardness = 5e5
    secondary_hardness = 1.0e7
